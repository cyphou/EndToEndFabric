# Agent Behavior Instructions — Microsoft Fabric to End-to-End Demo Migration
...
- **Pipeline**: Microsoft Fabric → End-to-End Demo
- **Source**: `src/`
- **Target**: `output/`
- **Tests**: `pytest tests/ --tb=short -q` — 33 test files
